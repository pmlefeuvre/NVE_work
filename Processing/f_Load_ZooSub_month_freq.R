#---------------------------------------------------------------#
#              Load Processed FREQUENCY LC Data from            #
...
Load_ZooSub_month_freq <- function(sub.start="05/15/2010 09:00",
                                   ...
                                   type="15min_mean")
{
    ...
    # Format Filename, Load and Subsample Data
        ...
        # If more than 3 months load several files and combine them
        ...
        # Filename
        datafile    <-paste("Data/Zoo/",dir.type,"/Zoo_LCallfreq_", type,"_",
                            daterange, ".csv", sep="")
