...
#---------------------------------------------------------------#
#      REORDER LOAD CELL DATA TO FIT 1992-2015 SEQUENCE         #
#                                                               #
# NOTES:                                                        #
...
Raw_editing <- function(year=2013){
...
# columns fit the used formats. Usually variables that were saved only
...
# Split Mar20001.dat into two files: 
...
# Split MAY03.dat into two files: 
